             ...
             <div id="content">
				...
				<div id="bottom" align="center">
					...
					<form id=loginform method=post name=loginform action="login">
						用户名：<input type=text id=userName name="uname" class="input_border" maxlength=16/> <p/>
						密<span style="visibility:hidden">码</span>码：<input type=password id=password name="upass" class="input_border"/></p>
						<br/>
